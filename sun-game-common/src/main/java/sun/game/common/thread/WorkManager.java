...
public class WorkManager extends DynamicFind implements HotNotify {
	...
	public void update(Class<?> newClz) throws Exception {
		...
		@SuppressWarnings("unchecked")
		Class<? extends Work> clz = (Class<? extends Work>) newClz;
		this.allWorks.put(newClz.getSimpleName(), clz);
	}
